...
class Ticket1Small extends StatelessWidget {
  const Ticket1Small(this.ticket, {super.key});
        ...
        children: [
          ...
          Positioned.fill(
            ...
            child: Align(
              ...
              child: SvgPicture.asset('assets/tickets/logo.svg', width: 43.36.w, height: 10.75.w),
            ),
          ),
        ],
      ),
...
class Ticket1Medium extends StatelessWidget {
  const Ticket1Medium(this.ticket, {super.key});
...
class Ticket1Large extends StatelessWidget {
  const Ticket1Large(this.ticket, {super.key});
                    ...
                    children: [
                      ...
                      Positioned.fill(
                        ...
                        child: Align(
                          ...
                          child: Padding(
                            padding: EdgeInsets.symmetric(horizontal: 7.w),
                            child: Text(ticket.title, style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w800, color: Colors.white)),
                          ),
                        ),
                      ),
                    ],
...
class Ticket2Small extends StatelessWidget {
  const Ticket2Small(this.ticket, {super.key});
...
class Ticket2Medium extends StatelessWidget {
  const Ticket2Medium(this.ticket, {super.key});
...
class Ticket2Large extends StatelessWidget {
  const Ticket2Large(this.ticket, {super.key});
...
class Ticket3Small extends StatelessWidget {
  const Ticket3Small(this.ticket, {super.key});
...
class Ticket3Medium extends StatelessWidget {
  const Ticket3Medium(this.ticket, {super.key});
...
class Ticket3Large extends StatelessWidget {
  const Ticket3Large(this.ticket, {super.key});
